...
namespace dg_turtlesim {
  ...
  TurtlesimTransform::TurtlesimTransform(const std::string  &inName)
    ...
    : dynamicgraph::Entity(inName), 
      ...
      robot_absolute_positionSIN(NULL,name+"::input(vector2d)::position of robot [x,y] in absolute frame::robot_absolute_position"),
      robot_orientationSIN(NULL,name+"::input(double)::orientation of the robot::robot_orientation"),
      absolute_positionSIN(NULL,name+"::input(vector2d)::position [x,y] in absolute frame::absolute_position"),
